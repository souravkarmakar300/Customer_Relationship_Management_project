...
if (isset($_POST['submit'])) {
    ...
    if (!empty($address)) {
        $sql = mysqli_query($conn, "update users set name='" . $_POST['user_name'] . "',contact='" . $_POST['user_phone'] . "',
         address='" . $_POST['address'] . "',gender='" . $_POST['user_gender'] . "' where id='" . $_SESSION['id'] . "'");
...
<body>
    ...
    <div class="container-fluid bg-secondary pb-3">
        <div class="box">
            <div>
                <h3 class="text-info pt-3 px-2 box2">
                    <?php echo $_SESSION['name'] ?> Profile
                </h3>
            </div>
            <div>
                <h6 class="box1 pt-3">Registration Date:
        ...
        <div class="row col-md-7">
            <div class="card offset-5">
                ...
                <?php
                $select = mysqli_query($conn, "SELECT * FROM users where email= '" . $_SESSION['email'] . "'");
                    ...
                    <div class="card-body bg-secondary">
                        <form action="" method="POST">
                            ...
                            <div class="md-2">
                                ...
                                <input type="radio" value="male" name="user_gender" checked />
                                Male
